...
def check(text):
    ...
    results = [
        ...
        ("Has biggest risk, verdict and next step",
         all(k in lower for k in ("biggest risk", "verdict", "next step")), ""),
